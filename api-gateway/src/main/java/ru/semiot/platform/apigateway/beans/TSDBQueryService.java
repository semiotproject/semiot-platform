...
public interface TSDBQueryService {
  ...
  public Observable<Model> queryBySystemId(String systemId, List<String> sensorsId, String start,
      String end);
  ...
  public Observable<Model> queryActuationsByRange(String systemId, ZonedDateTime start,
      ZonedDateTime end);
