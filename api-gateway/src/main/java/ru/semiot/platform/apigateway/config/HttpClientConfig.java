...
public class HttpClientConfig {
	...
	public String sendGetUrl(String url, HashMap<String, String> urlpParam,
			boolean autorizationWebConsole) throws Exception {
	...
	private InputStream sendGet(String url, boolean autorizationWebConsole)
			throws Exception {
		URL obj = new URL(url);
	...
	public String sendPost(String url, List<NameValuePair> postParams)
		...
		// "felix-webconsole-locale=ru_RU; JSESSIONID=0JSBKIuu1OEJMi4JKyydX5mS.ivan-pc");
	...
	// HTTP POST request
	// example
	// payload="{\"jsonrpc\":\"2.0\",\"method\":\"changeDetail\",\"params\":[{\"id\":11376}],\"id\":2}";
	public String sendPost(String url, HashMap<String, String> hashMap,
			HashMap<String, Object> payload) throws Exception {
		URL obj = new URL(url);
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
	...
	public String sendPostUploadFile(String url, InputStream inputStream,
			String filename) {
		...
		try {
			...
			symbolicName = jis.getManifest().getMainAttributes()
