...
public class DeviceManagerImpl implements DeviceManager {
    ...
    private static final String topicRegister = "ru.semiot.devices.register";
    private static final String topicsNewAndObserving = "ru.semiot.devices.newandobserving";
    private static final String wampUri = "ws://demo.semiot.ru:8080/ws";
    private static final String wampRealm = "realm1";
    private static final int wampReconnectInterval = 15;
    ...
    private void initWampRouter() {
        try {
            WAMPClient
                    .getInstance()
                    .init(wampUri, wampRealm,wampReconnectInterval)
                    .subscribe(
