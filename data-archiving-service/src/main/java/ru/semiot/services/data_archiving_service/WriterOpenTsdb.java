...
public class WriterOpenTsdb {
    ...
    public void sendMetricToSet(String nameMetric, Object value,
        ...
        logger.info("Add to set metric={}, value={}, timestamp={}", 
                nameMetric, value, timestamp);
    ...
    public void send(String nameMetric, Object value, Long timestamp,
        ...
        logger.info("Send metric={}, value={}, timestamp={}", nameMetric, value, timestamp);
    ...
    public void start() {
        ...
        this.handle = this.scheduler.scheduleAtFixedRate(this.scheduledRecord,
                0, nDelay, SECONDS);
        logger.info("UScheduled started. Repeat will do every {} seconds", nDelay);
    }
